...
#ifndef frpdamagemodel_h
#define frpdamagemodel_h
...
/**
 * Base class representing general frp damage model.
 * It is based on frp damage concept, assuming that damage evolution law
